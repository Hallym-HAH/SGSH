            ...
            <aside id="default-sidebar" className="fixed w-64 h-screen transition-transform -translate-x-full md:translate-x-0 bg-white md:border-r border-[#e4e7ec]" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto">
                    <ul className="space-y-4">
                        ...
                        <li>
                            <Link href="/manage/reserve" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                <svg aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill={`${pathname == ("/manage/reserve") ? '#ba5c54' : 'currentColor'}`} viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                                <p className={`flex-1 ml-3 whitespace-nowrap ${pathname == ("/manage/reserve") ? 'font-bold text-[#ba5c54]' : ''}`}>예약 관리</p>
                                <span className="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-gray-800 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300">Pro</span>
                            </Link>
                        </li>
                        <li>
                            <Link href="/manage/sales" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <p className={`flex-1 ml-3 whitespace-nowrap ${pathname == ("/manage/sales") ? 'font-bold text-[#ba5c54]' : ''}`}>매출 관리</p>
